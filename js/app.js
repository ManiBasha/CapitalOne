...
// ============================================================
import { auth, onAuth, loginWithGoogle, loginAnonymously, logout } from "./firebase.js?v=20260705b";
import { getProfile } from "./database.js?v=20260705b";
import { initSetup } from "./setup.js?v=20260705b";
import { initInvestments, getInvestmentsData, aggregateInvestments, openInvModal } from "./investments.js?v=20260705b";
import { initWealth, getWealthData } from "./wealth.js?v=20260705b";
import { initGoals, openGoalModal, getGoalsData } from "./goals.js?v=20260705b";
import { initTax } from "./tax.js?v=20260705b";
import { initSettings } from "./settings.js?v=20260705b";
import { refreshDashboard, bindDashboardQuickActions } from "./dashboard.js?v=20260705b";
import { refreshPortfolioPage } from "./portfolio.js?v=20260705b";
import { refreshChartTheme } from "./charts.js?v=20260705b";
import { initThemeEngine, applyThemeVars, applyStoredAppIcon } from "./theme.js?v=20260705b";
import {
  formatCurrency, toast, ls, debounce
} from "./utils.js?v=20260705b";
...
const initApp = async () => {
  ...
  document.addEventListener("click", (e) => {
    const item = e.target.closest('[data-action="navigate-portfolio"]');
    if (item) navigateTo("portfolio");
  });
